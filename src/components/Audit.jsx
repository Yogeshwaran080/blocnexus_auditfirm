            ...
            return (
              ...
              >
                <div>
                  ...
                  <ul className="space-y-4 mb-10">
                    {service.points.map((point, i) => (
                      <li
                        key={i}
                        className="flex items-center gap-3 text-gray-700 font-medium text-[15px]"
                      >
                ...
                <button
                  ...
                  className="group flex items-center justify-between bg-[#EFEFEF] hover:bg-[#E5E5E5] text-gray-900 px-6 py-4 rounded-full w-full font-semibold transition-all duration-300"
                >
