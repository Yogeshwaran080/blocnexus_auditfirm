      ...
      >
        <div className="flex h-16 max-w-[1440px] items-center ml-1 w-full">
          ...
          >
            ...
            <span
              className="
                -ml-4 /* Pulls the text left into the image's bounding box */
                text-[20px]
                lg:text-[26px]
                font-light
                tracking-[0.18em]
                                ...
                                >
                                  ...
                                  >
                                    <Icon
                                      ...
                                      size={18}
                                      // Corrected item reference string evaluation syntax
                                    />
                                  </div>
          ...
          {/* DESKTOP CTA (SHIFTED SAFELY LEFT AWAY FROM THE EDGE) */}
