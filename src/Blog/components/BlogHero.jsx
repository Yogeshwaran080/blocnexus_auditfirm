...
export default function BlogHero({ search, setSearch, posts = [] }) {
  ...
  return (
    <section style={{ fontFamily: "'Inter', sans-serif" }} className="relative bg-black pt-40 pb-24 px-6 overflow-hidden">
      <GridBackground />
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <h1 className="mt-6 text-5xl md:text-7xl font-light tracking-tight text-white">
          Blogs & Research
        </h1>

        <p className="mt-6 max-w-3xl mx-auto text-lg font-light text-slate-400">
